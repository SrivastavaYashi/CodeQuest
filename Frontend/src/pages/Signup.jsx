    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200">
      ...
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title justify-center text-3xl mb-6">CodeQuest</h2>{" "}
...
//     return(
//         <>
//         <form onSubmit={handleSubmit((data) => console.log(data))} className='min-h-screen flex flex-col justify-center items-center gap-y-2 max-w-xl ml-10'>
